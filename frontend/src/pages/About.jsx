...
const About = () => {
  return (
    <div className='text-white '>
        <div className='w-full my-[-120px] mx-auto text-center flex flex-col justify-center font-bold mt-[100px] lg:w-[800px] '>
          ...
          This website is meant to bring opportunity for different artists from Batangas to showcase their artwork and potentially get discovered. That 
