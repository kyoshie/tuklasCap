...
const Cards = () => {
  ...
  return (
      <div  className="h-[90dvh] w-screen md:items-center md:flex md:flex-wrap md:justify-center grid grid-cols-2
      lg:w-[100vw] overflow-y-scroll md:overflow-y-scroll gap-2">
