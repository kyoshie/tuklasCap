...
const Cards = () => {
  ...
  return (
      <div  className="h-[90dvh] w-screen overflow-y-auto lg:items-center md:items-center lg:flex lg:flex-wrap lg:justify-center md:flex md:flex-wrap md:justify-center grid grid-cols-2">
