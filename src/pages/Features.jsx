...
const Component = () => {
  return (
    <section className="w-full py-6 text-white md:py-24 lg:py-32 bg-[--background] h-full lg:fixed sm:overflow-hidden md:bg-[--background] md:h-[100vh] md:overflow-hidden lg:overflow-y-scroll 2xl:overflow-hidden ">
